...
Figure 4: G-Buffer representation
\end{ybox}
...
\end{tikzpicture}
\caption{\emph{Conceptual visualization of a G-Buffer layout created during the geometry pass. Here I haven't added the position texture as we can reconstruct position from depth}\label{fig:gbuffer-viz}}
\end{figure}
